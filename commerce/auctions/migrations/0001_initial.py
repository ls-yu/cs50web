...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Listing',
            fields=[
                ('category', models.CharField(choices=[('BOOKS', 'Books'), ('CLOTHING', 'Clothing'), ('COLLECTIBLES', 'Collectibles'), ('CRAFTS', 'Crafts'), ('TOYS', 'Toys'), ('HOME', 'Home'), ('PETS', 'Pet'), ('SPORTS', 'Sports')], default='BOOKS', max_length=12)),
